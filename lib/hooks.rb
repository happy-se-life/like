  ...
  class Hooks < Redmine::Hook::ViewListener
    ...
    def view_issues_show_details_bottom(context={})
      ...
      context[:controller].send(:render_to_string, {
        ...
        :locals => { id: context[:issue].id, count: like_count, type: 'issue' }
      })
    end
    ...
    def view_issues_history_journal_bottom(context={})
          ...
          context[:controller].send(:render_to_string, {
            ...
            :locals => { id: context[:journal].id, count: like_count, type: 'journal' }
          })
    end
    # Like icon on Wiki
    def view_layouts_base_content(context={})
      ...
      context[:controller].send(:render_to_string, {
        ...
        :locals => { id: wiki_id, count: like_count, type: 'wiki', is_wiki: is_wiki}
      })
    end
  end
end